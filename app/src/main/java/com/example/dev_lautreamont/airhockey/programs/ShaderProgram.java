...
import com.example.dev_lautreamont.airhockey.util.ShaderHelper;
import com.example.dev_lautreamont.airhockey.util.TextResourceReader;
 ...
 * AirHockey1
 * programs
 * Created by Leblanc, Frédéric on 2015-03-03, 11:52.
 * <p/>
 * Cette classe
 */
public class ShaderProgram {
    ...
    protected static final String U_SPECULAR_INTENSITY = "u_SpecularIntensity";
    protected static final String U_SPECULAR_POWER = "u_SpecularPower";
    ...
    protected ShaderProgram(Context context, int vertexShaderResourceId, int fragmentShaderResourceId) {
        ...
        program = ShaderHelper.buildProgam(
